...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents_7.setGeometry(QtCore.QRect(0, 0, 759, 646))
        ...
        self.abort_new_patient_pushButton.setObjectName(_fromUtf8("abort_new_patient_pushButton"))
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(_fromUtf8(":/save_all.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.save_new_patient_pushButton.setIcon(icon9)
        self.save_new_patient_pushButton.setObjectName(_fromUtf8("save_new_patient_pushButton"))
        ...
        self.scrollAreaWidgetContents_8.setGeometry(QtCore.QRect(0, 0, 741, 421))
        ...
        self.scrollAreaWidgetContents_5.setGeometry(QtCore.QRect(0, 0, 755, 465))
        ...
        self.reception_splitter.setObjectName(_fromUtf8("reception_splitter"))
        ...
        self.reception_webview.setProperty("url", QtCore.QUrl(_fromUtf8("about:blank")))
        self.reception_webview.setObjectName(_fromUtf8("reception_webview"))
        ...
        self.reception_webview2.setProperty("url", QtCore.QUrl(_fromUtf8("about:blank")))
        self.reception_webview2.setObjectName(_fromUtf8("reception_webview2"))
        ...
        self.reception_view_checkBox.setObjectName(_fromUtf8("reception_view_checkBox"))
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(_fromUtf8(":/ps.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.med_questionaire_print_pushbutton.setIcon(icon10)
        self.med_questionaire_print_pushbutton.setObjectName(_fromUtf8("med_questionaire_print_pushbutton"))
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/pencil.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.med_form_checked_button.setIcon(icon11)
        self.med_form_checked_button.setObjectName(_fromUtf8("med_form_checked_button"))
        ...
        self.medNotes_pushButton2.setObjectName(_fromUtf8("medNotes_pushButton2"))
        ...
        self.med_questionaire_textBrowser.setObjectName(_fromUtf8("med_questionaire_textBrowser"))
        ...
        self.misc_reception_groupBox.setObjectName(_fromUtf8("misc_reception_groupBox"))
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(_fromUtf8(":/vcard.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.notesSummary_webView.setProperty("url", QtCore.QUrl(_fromUtf8("about:blank")))
        ...
        self.notes_webView.setProperty("url", QtCore.QUrl(_fromUtf8("about:blank")))
        ...
        self.scrollAreaWidgetContents_11.setGeometry(QtCore.QRect(0, 0, 548, 367))
        ...
        self.scrollAreaWidgetContents_4.setGeometry(QtCore.QRect(0, 0, 198, 367))
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 772, 385))
        ...
        self.medhist_history_button.setObjectName(_fromUtf8("medhist_history_button"))
        ...
        self.main_tabWidget.addTab(self.tab_cashbook, icon12, _fromUtf8(""))
        ...
        self.daybook_filters_frame.setObjectName(_fromUtf8("daybook_filters_frame"))
        ...
        self.daybook_filters_pushButton.setObjectName(_fromUtf8("daybook_filters_pushButton"))
        ...
        self.daybook_filters_lineEdit.setObjectName(_fromUtf8("daybook_filters_lineEdit"))
        ...
        self.wiki_webView.setProperty("url", QtCore.QUrl(_fromUtf8("about:blank")))
        ...
        self.actionEnable_Filters.setObjectName(_fromUtf8("actionEnable_Filters"))
        ...
        self.actionEdit_Estimates.setObjectName(_fromUtf8("actionEdit_Estimates"))
        self.actionAllow_Edit_Treatment = QtGui.QAction(MainWindow)
        self.actionAllow_Edit_Treatment.setCheckable(True)
        self.actionAllow_Edit_Treatment.setObjectName(_fromUtf8("actionAllow_Edit_Treatment"))
        self.action_all_history_edits = QtGui.QAction(MainWindow)
        self.action_all_history_edits.setCheckable(True)
        self.action_all_history_edits.setObjectName(_fromUtf8("action_all_history_edits"))
        self.actionEdit_Referral_Centres = QtGui.QAction(MainWindow)
        self.actionEdit_Referral_Centres.setObjectName(_fromUtf8("actionEdit_Referral_Centres"))
        self.actionEdit_Feescales = QtGui.QAction(MainWindow)
        self.actionEdit_Feescales.setObjectName(_fromUtf8("actionEdit_Feescales"))
        ...
        self.actionReset_Supervisor_Password.setObjectName(_fromUtf8("actionReset_Supervisor_Password"))
        ...
        self.actionAdd_Clinician.setObjectName(_fromUtf8("actionAdd_Clinician"))
        self.actionEdit_Practice_Details = QtGui.QAction(MainWindow)
        self.actionEdit_Practice_Details.setObjectName(_fromUtf8("actionEdit_Practice_Details"))
        ...
        self.actionInsert_Regular_Blocks.setObjectName(_fromUtf8("actionInsert_Regular_Blocks"))

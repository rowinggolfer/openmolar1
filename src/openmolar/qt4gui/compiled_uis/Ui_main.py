...
#
# Created: Tue Apr 13 17:47:10 2010
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents_12.setGeometry(QtCore.QRect(0, 0, 1017, 595))
        ...
        self.scrollAreaWidgetContents_8.setGeometry(QtCore.QRect(0, 0, 642, 504))
        ...
        self.scrollAreaWidgetContents_5.setGeometry(QtCore.QRect(0, 0, 758, 446))
        ...
        self.scrollAreaWidgetContents_13.setGeometry(QtCore.QRect(0, 0, 104, 58))
        ...
        self.dayView_selectedBooks_radioButton = QtGui.QRadioButton(self.frame_18)
        self.dayView_selectedBooks_radioButton.setObjectName("dayView_selectedBooks_radioButton")
        self.verticalLayout_22.addWidget(self.dayView_selectedBooks_radioButton)
        self.dayView_smart_radioButton = QtGui.QRadioButton(self.frame_18)
        self.dayView_smart_radioButton.setChecked(True)
        self.dayView_smart_radioButton.setObjectName("dayView_smart_radioButton")
        self.verticalLayout_22.addWidget(self.dayView_smart_radioButton)
        ...
        self.aptOVdentscrollArea = QtGui.QScrollArea(self.schedule_frame)
        ...
        self.verticalLayout_36.addWidget(self.aptOVdentscrollArea)
        self.schedule_checkBox = QtGui.QCheckBox(self.schedule_frame)
        self.schedule_checkBox.setObjectName("schedule_checkBox")
        self.verticalLayout_36.addWidget(self.schedule_checkBox)
        self.schedule_tabWidget = QtGui.QTabWidget(self.schedule_frame)
        ...
        self.apt_drag_frame = QtGui.QFrame(self.tab_29)
        self.apt_drag_frame.setFrameShape(QtGui.QFrame.StyledPanel)
        self.apt_drag_frame.setFrameShadow(QtGui.QFrame.Raised)
        self.apt_drag_frame.setObjectName("apt_drag_frame")
        self.verticalLayout_37.addWidget(self.apt_drag_frame)
        self.schedule_tabWidget.addTab(self.tab_29, "")
        ...
        self.schedule_tabWidget.addTab(self.tab_30, "")
        self.verticalLayout_36.addWidget(self.schedule_tabWidget)
        ...
        self.gridLayout_11 = QtGui.QGridLayout(self.tab_24)
        self.gridLayout_11.setObjectName("gridLayout_11")
        self.scrollArea_9 = QtGui.QScrollArea(self.tab_24)
        self.scrollArea_9.setMinimumSize(QtCore.QSize(220, 0))
        self.scrollArea_9.setMaximumSize(QtCore.QSize(220, 16777215))
        ...
        self.scrollAreaWidgetContents_16 = QtGui.QWidget(self.scrollArea_9)
        self.scrollAreaWidgetContents_16.setGeometry(QtCore.QRect(0, 0, 220, 492))
        self.scrollAreaWidgetContents_16.setObjectName("scrollAreaWidgetContents_16")
        self.verticalLayout_23 = QtGui.QVBoxLayout(self.scrollAreaWidgetContents_16)
        self.verticalLayout_23.setObjectName("verticalLayout_23")
        self.frame_8 = QtGui.QFrame(self.scrollAreaWidgetContents_16)
        self.frame_8.setFrameShape(QtGui.QFrame.StyledPanel)
        self.frame_8.setFrameShadow(QtGui.QFrame.Raised)
        self.frame_8.setObjectName("frame_8")
        self.verticalLayout_28 = QtGui.QVBoxLayout(self.frame_8)
        ...
        self.weekCalendar_frame.setMinimumSize(QtCore.QSize(200, 180))
        self.weekCalendar_frame.setMaximumSize(QtCore.QSize(200, 200))
        self.weekCalendar_frame.setObjectName("weekCalendar_frame")
        self.verticalLayout_28.addWidget(self.weekCalendar_frame)
        ...
        self.verticalLayout_28.addWidget(self.goto_current_week_PushButton)
        self.aptOVdentscrollArea_2 = QtGui.QScrollArea(self.frame_8)
        self.aptOVdentscrollArea_2.setMinimumSize(QtCore.QSize(0, 100))
        self.aptOVdentscrollArea_2.setMaximumSize(QtCore.QSize(16777215, 16777215))
        self.aptOVdentscrollArea_2.setWidgetResizable(True)
        self.aptOVdentscrollArea_2.setObjectName("aptOVdentscrollArea_2")
        self.scrollAreaWidgetContents_15 = QtGui.QWidget(self.aptOVdentscrollArea_2)
        self.scrollAreaWidgetContents_15.setGeometry(QtCore.QRect(0, 0, 198, 111))
        self.scrollAreaWidgetContents_15.setObjectName("scrollAreaWidgetContents_15")
        self.verticalLayout_4 = QtGui.QVBoxLayout(self.scrollAreaWidgetContents_15)
        self.verticalLayout_4.setSpacing(2)
        self.verticalLayout_4.setMargin(2)
        self.verticalLayout_4.setObjectName("verticalLayout_4")
        self.aptOVdents_frame_2 = QtGui.QFrame(self.scrollAreaWidgetContents_15)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.aptOVdents_frame_2.sizePolicy().hasHeightForWidth())
        self.aptOVdents_frame_2.setSizePolicy(sizePolicy)
        self.aptOVdents_frame_2.setFrameShape(QtGui.QFrame.StyledPanel)
        self.aptOVdents_frame_2.setFrameShadow(QtGui.QFrame.Raised)
        self.aptOVdents_frame_2.setObjectName("aptOVdents_frame_2")
        self.verticalLayout_4.addWidget(self.aptOVdents_frame_2)
        self.aptOVdentscrollArea_2.setWidget(self.scrollAreaWidgetContents_15)
        self.verticalLayout_28.addWidget(self.aptOVdentscrollArea_2)
        self.schedule_checkBox_2 = QtGui.QCheckBox(self.frame_8)
        self.schedule_checkBox_2.setObjectName("schedule_checkBox_2")
        self.verticalLayout_28.addWidget(self.schedule_checkBox_2)
        self.schedule_tabWidget_2 = QtGui.QTabWidget(self.frame_8)
        self.schedule_tabWidget_2.setObjectName("schedule_tabWidget_2")
        self.tab_31 = QtGui.QWidget()
        self.tab_31.setObjectName("tab_31")
        self.horizontalLayout_17 = QtGui.QHBoxLayout(self.tab_31)
        self.horizontalLayout_17.setObjectName("horizontalLayout_17")
        self.apt_drag_frame_2 = QtGui.QFrame(self.tab_31)
        self.apt_drag_frame_2.setFrameShape(QtGui.QFrame.StyledPanel)
        self.apt_drag_frame_2.setFrameShadow(QtGui.QFrame.Raised)
        self.apt_drag_frame_2.setObjectName("apt_drag_frame_2")
        self.horizontalLayout_17.addWidget(self.apt_drag_frame_2)
        self.schedule_tabWidget_2.addTab(self.tab_31, "")
        self.tab_32 = QtGui.QWidget()
        self.tab_32.setObjectName("tab_32")
        self.verticalLayout_40 = QtGui.QVBoxLayout(self.tab_32)
        self.verticalLayout_40.setObjectName("verticalLayout_40")
        self.block_drag_frame_2 = QtGui.QFrame(self.tab_32)
        self.block_drag_frame_2.setFrameShape(QtGui.QFrame.StyledPanel)
        self.block_drag_frame_2.setFrameShadow(QtGui.QFrame.Raised)
        self.block_drag_frame_2.setObjectName("block_drag_frame_2")
        self.verticalLayout_40.addWidget(self.block_drag_frame_2)
        self.schedule_tabWidget_2.addTab(self.tab_32, "")
        self.verticalLayout_28.addWidget(self.schedule_tabWidget_2)
        self.verticalLayout_23.addWidget(self.frame_8)
        self.scrollArea_9.setWidget(self.scrollAreaWidgetContents_16)
        self.gridLayout_11.addWidget(self.scrollArea_9, 0, 0, 2, 1)
        ...
        self.gridLayout.addWidget(self.day6_frame, 0, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.appt_OV_Frame6, 1, 5, 1, 1)
        self.gridLayout_11.addLayout(self.gridLayout, 0, 1, 1, 1)
        self.horizontalLayout_6 = QtGui.QHBoxLayout()
        self.horizontalLayout_6.setObjectName("horizontalLayout_6")
        self.weekView_outOfOffice_checkBox = QtGui.QCheckBox(self.tab_24)
        ...
        self.horizontalLayout_6.addWidget(self.weekView_outOfOffice_checkBox)
        self.aptOV_apptscheckBox = QtGui.QCheckBox(self.tab_24)
        self.aptOV_apptscheckBox.setChecked(True)
        self.aptOV_apptscheckBox.setObjectName("aptOV_apptscheckBox")
        self.horizontalLayout_6.addWidget(self.aptOV_apptscheckBox)
        ...
        self.gridLayout_11.addLayout(self.horizontalLayout_6, 1, 1, 1, 1)
        ...
        self.scrollAreaWidgetContents_14.setGeometry(QtCore.QRect(0, 0, 965, 459))
        ...
        self.gridLayout_5.addWidget(self.monthView_scrollArea, 0, 0, 1, 2)
        ...
        self.gridLayout_5.addWidget(self.printMonth_pushButton, 1, 1, 1, 1)
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 965, 492))
        ...
        spacerItem21 = QtGui.QSpacerItem(389, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.gridlayout1.addItem(spacerItem21, 0, 5, 2, 1)
        ...
        spacerItem22 = QtGui.QSpacerItem(654, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.gridlayout2.addItem(spacerItem22, 0, 6, 2, 1)
        ...
        spacerItem23 = QtGui.QSpacerItem(206, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.gridLayout_9.addItem(spacerItem23, 0, 1, 1, 1)
        ...
        spacerItem24 = QtGui.QSpacerItem(746, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.gridLayout_9.addItem(spacerItem24, 2, 0, 1, 2)
        ...
        spacerItem28 = QtGui.QSpacerItem(67, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.gridLayout_30.addItem(spacerItem28, 2, 0, 1, 1)
        ...
        self.schedule_tabWidget.setCurrentIndex(0)
        self.schedule_tabWidget_2.setCurrentIndex(0)
...
"If the \"changes only\" checkbox is checked, only data which has been changed will be displayed."))
        ...
        self.schedule_checkBox.setText(_( u"schedule appointments"))
        self.schedule_tabWidget.setTabText(self.schedule_tabWidget.indexOf(self.tab_29), _( u"Current Patient"))
        self.schedule_tabWidget.setTabText(self.schedule_tabWidget.indexOf(self.tab_30), _( u"Blocks etc.."))
        ...
        self.schedule_checkBox_2.setText(_( u"schedule appointments"))
        self.schedule_tabWidget_2.setTabText(self.schedule_tabWidget_2.indexOf(self.tab_31), _( u"Current Patient"))
        self.schedule_tabWidget_2.setTabText(self.schedule_tabWidget_2.indexOf(self.tab_32), _( u"Blocks etc.."))

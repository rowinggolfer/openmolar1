...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(_("Open Molar - YOUR dental database application"))
        ...
        self.relatedpts_pushButton.setText(_("&Related"))
        self.relatedpts_pushButton.setShortcut(_("Ctrl+G"))
        self.daylistBox.setToolTip(_("A drop down box of all patients who have an appointment today."))
        ...
        self.editMore_pushButton.setToolTip(_("More Fields are available. Click Here to Edit."))
        self.editMore_pushButton.setText(_("More"))
        ...
        self.pushButton_2.setToolTip(_("send an email"))
        self.pushButton_2.setText(_("email"))
        self.label_5.setText(_("Address2"))
        self.label_23.setText(_("email2"))
        self.pushButton_3.setToolTip(_("send an email"))
        self.pushButton_3.setText(_("email"))
        ...
        self.np_groupBox.setTitle(_("New Patients"))
        self.defaultNP_pushButton.setToolTip(_("Use the Sname and Address details from the previous patient."))
        self.defaultNP_pushButton.setText(_("Default Sname / Address"))
        self.familyNewPatient_pushButton.setToolTip(_("Not implemented yet."))
        self.familyNewPatient_pushButton.setText(_("Family"))
        self.npEdit_label.setText(_("Higlighted Fields are Mandatory for New Patients"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_4), _("Patient Details"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_11), _("Contract"))
        self.groupBox_6.setTitle(_("Letters TO the patient"))
        self.standardLetterPushButton.setText(_(" Custom Letter to the patient"))
        self.groupBox_15.setTitle(_("Recall management"))
        self.recall_dateEdit.setToolTip(_("Set the date for a recall to be generated automatically"))
        self.recallDate_comboBox.setItemText(0, _("Date Shortcuts"))
        self.recallDate_comboBox.setItemText(1, _("1 Month hence"))
        self.recallDate_comboBox.setItemText(2, _("3 Months hence"))
        self.recallDate_comboBox.setItemText(3, _("6 Months hence"))
        self.recallDate_comboBox.setItemText(4, _("12 Months hence"))
        self.printRecall_pushButton.setToolTip(_("Print a recall saying the patient is due now."))
        self.printRecall_pushButton.setText(_("Print letter Now"))
        self.groupBox_9.setTitle(_("Accounts"))
        self.accountA_radioButton.setText(_("\"A\" letter"))
        self.accountB_radioButton.setText(_("\"B\" letter"))
        self.accountC_radioButton.setText(_("\"C\" letter"))
        self.groupBox_2.setTitle(_("Duplicate Receipt"))
        self.label_7.setText(_("Date"))
        self.label_11.setText(_("Amount"))
        self.receiptPrintButton.setToolTip(_("Print a receipt - useful for duplicates."))
        self.receiptPrintButton.setText(_("Print"))
        self.account2_pushButton.setText(_("Print A Statement of Account"))
        self.groupBox_3.setTitle(_("Previous Correspondence"))
        self.previousCorrespondence_treeWidget.headerItem().setText(0, _("1"))
        self.groupBox_7.setTitle(_("Referrals (Letters about the patient)"))
        self.referralLettersPrintButton.setText(_("Print"))
        self.groupBox_8.setTitle(_("Export this record card"))
        self.exportChartPrintButton.setToolTip(_("Print a patient\'s static chart."))
        self.exportChartPrintButton.setText(_("Print the Patient\'s static Chart"))
        self.simpleNotesPrintButton.setToolTip(_("Print a summary of the patient\'s notes (for them to take on). Includes No fee details."))
        self.simpleNotesPrintButton.setText(_("Print A Summary of the Notes"))
        self.detailedNotesPrintButton.setToolTip(_("Print a summary of the patient\'s notes. Includes FEE and ESTIMATE details."))
        self.detailedNotesPrintButton.setText(_("Print Detailed Notes"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_6), _("Correspondence"))
        self.adminAccount_groupBox.setTitle(_("Account"))
        ...
        self.groupBox.setTitle(_("Patient\'s Diary"))
        self.ptAppointment_treeWidget.headerItem().setText(0, _("1"))
        self.newAppt_pushButton.setText(_("&New"))
        self.makeAppt_pushButton.setText(_("Schedule"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_7), _("Reception"))
        ...
        self.charge_pushButton.setText(_("Charge"))
        self.medNotes_pushButton.setText(_("Med Notes"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), _("Clinical Summary"))
        self.label_35.setText(_("Verbosity Level"))
        self.notesMinimumVerbosity_radioButton.setText(_("minimum"))
        self.notesMediumVerbosity_radioButton.setText(_("medium"))
        self.notesMaximumVerbosity_radioButton.setText(_("maximum"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _("Notes"))
        self.chartsview_pushButton.setText(_("Charts View"))
        self.static_groupBox.setTitle(_("Static"))
        self.plan_groupBox.setTitle(_("Plan"))
        self.completed_groupBox.setTitle(_("Completed"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _("Charts"))
        self.estimate_groupBox.setTitle(_("Estimate"))
        self.groupBox_5.setTitle(_("Course Management"))
        self.label_22.setText(_("Course Dentist"))
        self.newCourse_pushButton.setText(_("New Course Of Treatment"))
        self.closeTx_pushButton.setText(_("Close Course"))
        self.groupBox_16.setTitle(_("Estimate Management"))
...
"Note - this will not remove items which are currently there. "))
        ...
        self.estView_comboBox.setItemText(0, _("Standard View"))
        self.estView_comboBox.setItemText(1, _("Expanded View"))
        self.estView_comboBox.setItemText(2, _("Plan/Completed (standard)"))
        self.estView_comboBox.setItemText(3, _("Plan/Completed (expanded)"))
        self.groupBox_4.setTitle(_("Treatment Planning"))
        self.examTxpushButton.setText(_("Perform Exam"))
        self.perioTxpushButton.setText(_("Perio"))
        self.xrayTxpushButton.setText(_("X-Rays"))
        self.dentureTxpushButton.setText(_("Dentures"))
        self.OrthoTxpushButton.setText(_("Ortho"))
        self.otherTxpushButton.setText(_("Other Tx"))
        self.customTx_pushButton.setText(_("Add Custom Item"))
        self.planDetails_groupBox.setTitle(_("Details"))
        self.plan_treeWidget.setSortingEnabled(True)
        self.plan_treeWidget.headerItem().setText(0, _("Plan"))
        self.comp_treeWidget.setSortingEnabled(True)
        self.comp_treeWidget.headerItem().setText(0, _("Completed"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_5), _("Estimate/Plan"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_8), _("Perio Charts"))
        self.pastData_toolButton.setText(_("History Options"))
        self.debug_toolButton.setText(_("debug"))
        self.ptAtts_checkBox.setText(_("changes only"))
        self.historyPrint_pushButton.setText(_("Print"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_9), _("History"))
        self.main_tabWidget.setTabText(self.main_tabWidget.indexOf(self.tab_10), _("Patient Database"))
        self.goTodayPushButton.setText(_("Go To Today"))
        self.label_62.setText(_("Week"))
        self.label_63.setText(_("Month"))
        self.aptOV_emergencycheckBox.setText(_("show emergency spaces"))
        self.aptOV_lunchcheckBox.setText(_("show lunch breaks"))
        self.aptOV_apptscheckBox.setText(_("show appointments"))
        self.label_42.setText(_("Font Size"))
        self.aptOVmode_label.setText(_("View Mode"))
        self.apptFrameLabel1.setText(_("Book"))
        self.printBook1_pushButton.setText(_("Print"))
        self.book1memo_label.setText(_("Memo"))
        self.apptFrameLabel2.setText(_("Book"))
        self.printBook2_pushButton.setText(_("Print"))
        self.apptFrameLabel3.setText(_("Book"))
        self.printBook3_pushButton.setText(_("Print"))
        self.apptFrameLabel4.setText(_("Book"))
        self.printBook4_pushButton.setText(_("Print"))
        self.diary_tabWidget.setTabText(self.diary_tabWidget.indexOf(self.tab_26), _("Day View"))
        self.diary_tabWidget.setTabText(self.diary_tabWidget.indexOf(self.tab_24), _("Week View"))
        self.diary_tabWidget.setTabText(self.diary_tabWidget.indexOf(self.tab_25), _("Month View"))
        self.diary_tabWidget.setTabText(self.diary_tabWidget.indexOf(self.tab_13), _("Year View"))
        self.diary_tabWidget.setTabText(self.diary_tabWidget.indexOf(self.tab_27), _("Memos and Tasks"))
        self.main_tabWidget.setTabText(self.main_tabWidget.indexOf(self.tab_17), _("Appointments / Diary"))
        ...
        self.main_tabWidget.setTabText(self.main_tabWidget.indexOf(self.tab_12), _("Cashbook"))
        ...
        self.main_tabWidget.setTabText(self.main_tabWidget.indexOf(self.tab_16), _("Daybook"))
        ...
        self.accountsTotal_doubleSpinBox.setPrefix(_("£"))
        self.printAccountsTable_pushButton.setText(_("Print Table"))
        self.main_tabWidget.setTabText(self.main_tabWidget.indexOf(self.tab_14), _("Accounts"))
        self.label_24.setText(_("choose month"))
        self.recalldateEdit.setDisplayFormat(_("MM/yyyy"))
        self.recallpushButton.setText(_("Find Patients"))
        self.main_tabWidget.setTabText(self.main_tabWidget.indexOf(self.tab_15), _("Recalls"))
        self.chooseFeescale_comboBox.setItemText(0, _("Show All Fee Scales"))
        self.chooseFeescale_comboBox.setItemText(1, _("Private FeeScale"))
        self.chooseFeescale_comboBox.setItemText(2, _("NHS FeeScale 2008"))
        self.feeItems_comboBox.setItemText(0, _("Show All Items"))
        self.feeItems_comboBox.setItemText(1, _("Favourite Items Only"))
        ...
        self.feeSearch_pushButton.setText(_("Find"))
        self.feeSearch_pushButton.setShortcut(_("Ctrl+F"))
        self.label_27.setText(_("NHS Regulation Document"))
        self.nhsRegs_pushButton.setToolTip(_("Open A PDF of the latest NHS Regulations"))
        self.nhsRegs_pushButton.setText(_("Open"))
        self.feesColumn_comboBox.setItemText(0, _("Default Columns"))
        self.feesColumn_comboBox.setItemText(1, _("Show Geek Column"))
        self.feesColumn_comboBox.setItemText(2, _("All Columns"))
        self.fees_treeWidget.headerItem().setText(0, _("1"))
        self.main_tabWidget.setTabText(self.main_tabWidget.indexOf(self.tab_22), _("Feescales"))
        ...
        self.label_37.setText(_("Search by initials"))
        self.feeSearch_pushButton_3.setToolTip(_("Click on this Button to search for in patient in your database."))
        self.feeSearch_pushButton_3.setText(_("Find"))
        self.feeSearch_pushButton_3.setShortcut(_("Ctrl+F"))
        self.main_tabWidget.setTabText(self.main_tabWidget.indexOf(self.tab_23), _("FORUM"))
        ...
        self.actionAppointment_Font_Size.setText(_("Appointment Font Size"))
        ...
        self.actionTest_Print_an_NHS_Form.setText(_("Test Print an NHS Form"))
        self.actionOptions.setText(_("options"))
        self.actionLog_queries_in_underlying_terminal.setText(_("log queries in underlying terminal"))
        self.actionSet_Clinician.setText(_("Set Clinician"))
        self.actionAppointment_Tools.setText(_("Appointment Tools"))
        self.actionChoose_Database.setText(_("Choose Database"))
        self.actionFeeScale_Adjuster.setText(_("FeeScale Adjuster"))
        self.actionSelect_Print_Daylists.setText(_("Select && Print Daylists"))

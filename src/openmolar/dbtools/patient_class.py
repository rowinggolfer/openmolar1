...
class patient(object):
    ...
    itemcode=None, csetype=None, descr=None, chosen_feescale=None, 
    n_identical_items=0, fee=None, ptfee=None, completed=False):
        '''
        ...
        if fee == None:
            ...
            itemcode, 1, no_already_in_estimate=n_identical_items)
        else:

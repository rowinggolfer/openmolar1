    ...
    if changes == []:
        ...
        for change in changes:
            ...
            not exemptionsHandled):
                ...
                oldEstDict={}
                if pt.courseno == pt_dbstate.courseno:

                    for est in  pt_dbstate.estimates:
                        #-- generate a dictionary with the autogenerated db index
                        #--as key
                        if est.ix != None:
...
def OLDtoNotes(serialno, newnotes):
    '''

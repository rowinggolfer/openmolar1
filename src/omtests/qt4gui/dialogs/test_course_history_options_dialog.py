...
from openmolar.qt4gui.dialogs.course_history_options_dialog import \
...
class TestDialog(BaseTestDialog):
    ...
    dl_class = CourseHistoryOptionsDialog

    def test_exec(self):
        self.exec_()
        print(self.dl.include_estimates, self.dl.include_daybook)

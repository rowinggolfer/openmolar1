...
#
# Created: Thu May 21 23:04:34 2009
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.gridLayout.addItem(spacerItem1, 2, 2, 3, 1)
        self.tooth_lineEdit = QtGui.QLineEdit(Dialog)
        self.tooth_lineEdit.setMaxLength(3)
        self.tooth_lineEdit.setObjectName("tooth_lineEdit")
        self.gridLayout.addWidget(self.tooth_lineEdit, 2, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.fee_doubleSpinBox, 3, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.ptFee_doubleSpinBox, 4, 3, 1, 1)
        ...
        self.label_5.setBuddy(self.tooth_lineEdit)
        ...
        Dialog.setTabOrder(self.description_lineEdit, self.tooth_lineEdit)
        Dialog.setTabOrder(self.tooth_lineEdit, self.fee_doubleSpinBox)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_5.setText(QtGui.QApplication.translate("Dialog", "Tooth (if applicable)", None, QtGui.QApplication.UnicodeUTF8))
